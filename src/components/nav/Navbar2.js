  ...
  return (
    <>
      ...
      <Navbar
        fixed="top"
        expand="lg"
        className="bg-body-tertiary mb-3 navbar-fixed-top nav-wid"
      >
        ...
        <Nav variant="underline" className="wid-nav">
          ...
          >
            ...
            <Offcanvas.Body>
              <Stack className="offcan">
                <Row className="navigation-top offcan">
                  ...
                  <Col>
                    <Nav className=" p-2 ms-auto justify-content-end ">
                      <NavDropdown
                        title="+977 1 5970015"
                ...
                <Row className="navigation-bottom offcan nav-wid">
                      ...
                      >
                        <NavDropdown.Item className="whitespace">
                          <Row className="megam">
                            ...
                            <Col md={6}>
                              <h4>
                                Western Union- Account Payment Network (WU APN)
                              </h4>
                              <img
                    ...
                    <Row className="row-height">
                      <Col>
                        <Dropdown className="d-inline mx-2  ">
                          ...
                          <Dropdown.Menu className="pos-drop ttt">
                            <Dropdown.Item
                              href="https://nbank.nabilbank.com/"
                              target="_blank"
                            >
