              ...
              <Stack>
                <div className="navigation-top">
                  <Stack direction="horizontal" gap={3}>
                    <Nav className=" navigation-top--left" bsStyle="tabs">
                      {/* <Tabs
                      ...
                      <HashLink
                        to="http://localhost:3000/nav/#individual"
                    ...
                    <Nav className="p-2 ms-auto hover-underline list-unstyled mb-0 justify-content-end flex-grow-1 pe-3">
                      <NavDropdown
                        title="+977 1 5970015"
