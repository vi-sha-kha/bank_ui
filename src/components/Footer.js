                ...
                <div class="footer__pageLinks">
                  <div>
                    ...
                    <ul class="list-unstyled">
                      <li>
                        <img
                          src="data:image/png;base64,"
                          class="img-fluid mr-2"
                          alt=""
                        />
                        <a href="mailto:customercare@nabilbank.com">
                          customercare@nabilbank.com
                        </a>
                      </li>
                      <li>
                        <img
                          src="data:image/png;base64,"
                          class="img-fluid mr-2"
                          alt=""
                        />
                        <a href="tel:+977 1 5970015">+977 1 5970015</a>
                      </li>
                      <li>SWIFT: NARBNPKA</li>
                    </ul>
                  </div>
                </div>
                <ul>
                  ...
                  <li>
                    <div>
                      ...
                      <ul class="list-unstyled d-flex social-link-lists">
                        ...
                        <li>
                          <a
                            href="https://www.instagram.com/nabilbank/"
                        ...
                        <li>
                          <a
                            href="https://twitter.com/nabilbank"
                            class="twitter-icon"
                            target="_blank"
                          >
                            <svg
                        ...
                        <li>
                          <a
                            href="https://www.linkedin.com/company/nabil-bank/"
                            target="_blank"
                            class="linkedin-icon"
                          >
                            <svg
                        ...
                        <li>
                          <a
                            href="https://www.youtube.com/channel/UCuJCYvI-WOJ9awI3Gxo_sMw"
                            target="_blank"
                            class="youtube-icon"
                          >
                            <svg
                        ...
                        <li>
                          <a
                            href="https://www.pinterest.com/nabilbank/_saved/"
                            target="_blank"
